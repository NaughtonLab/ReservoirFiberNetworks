...
if __name__ == '__main__':
    ...
    params = {
        ...
        'point_force_mag': -1e-1, #-0.2 # 1 N = kg m/s2 --> 1e6 g mm/s2 --> 1e3 mg mm /ms2 
        ...
        'k': 1e9*1e-3, # translational stiffness of connection
        ...
        'loc': 'Simulations/Polygon/', #'./SMASIS_constant_force/',
        'file_type': 'npz'
    }
