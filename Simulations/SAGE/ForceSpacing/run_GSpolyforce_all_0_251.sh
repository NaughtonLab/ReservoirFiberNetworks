#!/bin/bash
#SBATCH --job-name=GSpolyforce_Array
#SBATCH --array=0-25
...
# Cap the end index at 251
if [ $END -gt 251 ]; then
    END=251
fi

BASE_FILE_NAME='fiber_config_GSPolyForceSpacing'
...
cd /projects/naughton/Apoorva/fiber_network_project/fiber_network_polygon/ || { echo "Cannot cd into dir"; exit 1; }
