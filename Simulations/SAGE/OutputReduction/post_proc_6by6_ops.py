...
if __name__ == '__main__':
    ...
    # test_size = 0.25
    # alpha = 0.1
    # mem_capacity_train_list, mem_capacity_test_list, mem_R2_train_list, mem_R2_test_list = memory_testing(input_data[0], output_data[0], max_timesteps_back, regressor, test_size, alpha, sample_freq)

    # np.savez(f"./{n}by{n}_ops_conns.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    ...
    # np.savez(f"./{n}by{n}_ops_hors.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    #             legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
    #             memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))

    '''Only vertical midpoints'''
    # n = 6
    # file_path = f"./{n}by{n}rods_spacing1.6666e+02m_PF-9e-02Nspline_fps250_stepskip800"
    ...
    # np.savez(f"./{n}by{n}_ops_vers.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    #             legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
    #             memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))

    '''Only horizontal midpoints without actuation point'''
    n = 6
    file_path = f"./{n}by{n}rods_spacing1.6666e+02m_PF-9e-02Nspline_fps250_stepskip800"
    ...
    np.savez(f"./{n}by{n}_ops_hors_no_act.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
                legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
                memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))

    '''Connection nodes and horizontal midpoints'''
    # n = 6
    # file_path = f"./{n}by{n}rods_spacing1.6666e+02m_PF-9e-02Nspline_fps250_stepskip800"
    ...
    # np.savez(f"./{n}by{n}_ops_conns_hors.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    #             legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
    #             memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))

    '''Connection nodes and vertical midpoints'''
    # n = 6
    # file_path = f"./{n}by{n}rods_spacing1.6666e+02m_PF-9e-02Nspline_fps250_stepskip800"
    ...
    # np.savez(f"./{n}by{n}_ops_conns_vers.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    #             legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
    #             memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))
    ...
    # np.savez(f"./{n}by{n}_ops_hors_vers.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    #             legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
    #             memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))

    '''Horizontal and Vertical midpoints without actuation point'''
    # n = 6
    # file_path = f"./{n}by{n}rods_spacing1.6666e+02m_PF-9e-02Nspline_fps250_stepskip800"
    ...
    # np.savez(f"./{n}by{n}_ops_hors_vers_no_act.npz", input_data=input_data[0], output_data=output_data[0], time_data=time_data[0],
    #             legendre_R2=(leg_R2_train_list, leg_R2_test_list), legendre_cap=(leg_capacity_train_list, leg_capacity_test_list),
    #             memory_R2=(mem_R2_train_list, mem_R2_test_list), memory_cap=(mem_capacity_train_list, mem_capacity_test_list))