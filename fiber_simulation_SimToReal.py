...
class fiber_simulation():
    ...
    def __init__(self, **kwargs):
        ...
        if self.scaling_type == "mm_g_s":
            ...
            self.step_skip = np.rint(1.0 / (self.rendering_fps * self.sim_dt * 1e-3)).astype(int)
        else:
        ...
        self.SAVE = kwargs.get("CALLBACK", True)
    ...
    def save_data(self, data, name):
        if self.file_type == "pickle":
            ...
            raise NotImplementedError ("This file type is invalid!!")
    ...
    def launch_sim(self):
        ...
        if self.TYPE_PF=="constant":
            ...
            raise NotImplementedError ("This type of point force has not been implemented!!")
        ...
        if not stopped_at_nan:
            ...
            if self.SAVE:
                ####### Save data as pickle or npz file #######
            ...
            if self.VIDEO:
                ...
                # os.remove(f'{self.loc}{name}.{self.file_type}')
