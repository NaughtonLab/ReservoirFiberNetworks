...
if __name__ == '__main__':
    ...
    grid = np.load(f'{parent_folder}/thread_spacing_grid_NL.npz', allow_pickle=True)
    grid = grid['grid']

    parser = argparse.ArgumentParser(description="Script that configures and launches fiber_simulation for Thread Spacing grid search on best Nonlinearity")
