...
from utils.forces.pointforce import PointForce, PointForceSinsusoidal, PointForceSpline, PointForceVaryingSinsusoidal
...
class fiber_simulation():
    ...
    def launch_sim(self):
        ...
        name = f"test4_{self.num_horizontal_threads}by{self.num_vertical_threads}rods_{suffix}"
        print(name)
